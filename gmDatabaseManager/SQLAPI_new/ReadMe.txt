****************************************************************
               Welcome to SQLAPI++ Library 5.1.5
****************************************************************
...
bcc-cb?\*		- SQLAPI++ precompiled binaries for Embarcadero RAD Studio (x86 and x86-64)
...
binaries[-g++-?.?][-i386/-amd64].tar.gz	    - archives of SQLAPI++ binaries compiled with different g++ versions (x86 and amd64)
